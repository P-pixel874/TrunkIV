...
$sql="update tblclients set FirstName=:fname,LastName=:lname,Sector=:sector,DoApp=:doApp,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
$query = $dbh->prepare($sql);
$query->bindParam(':fname',$fname,PDO::PARAM_STR);
$query->bindParam(':lname',$lname,PDO::PARAM_STR);
$query->bindParam(':sector',$sector,PDO::PARAM_STR);
$query->bindParam(':doApp',$doApp,PDO::PARAM_STR);
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h5>Update Client Infor</h5></div>
                    </div>
...
<label for="empcode">Client ID</label>
...
<select  name="sector" autocomplete="on">
<option value="<?php echo htmlentities($result->Sector);?>"><?php echo htmlentities($result->Sector);?></option>                                          
<option value="Male">Private</option>
<option value="Female">Public</option>
<option value="Other">Other</option>
</select>
</div>
<label for="birthdate">Date of Application</label>
<div class="input-field col m6 s12">

<input id="birthdate" name="doApp"  class="datepicker" value="<?php echo htmlentities($result->DoApp);?>" >
</div>
