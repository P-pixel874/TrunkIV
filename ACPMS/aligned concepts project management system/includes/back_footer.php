<footer class="footer">
    <div class="container footer-inner">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: No. 21 San Marino Office Pack Albertyn Street Johannesburg South Africa
                        </li>
                        <li>
                            Email: <a href="mailto:info@AlignedConcepts.com">info@AlignedConcepts.com</a>
                        </li>
                        <li>
                            Phone: <a href="tel:0027 737 192">+0027 737 133 192</a>
                        </li>
                    </ul>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="admin/index.php"><i class="fa fa-angle-right"></i>Admin</a>
                        </li>
                        <li>
                            <a href="client_home.php"><i class="fa fa-angle-right"></i>Client</a>
                        </li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copyright">Developed By<a href="https://nyamondoprox.simdif.com">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;©pnyamondo@Amazing_Technostars.com </a></p>
            </div>
        </div>
    </div>
</footer>
