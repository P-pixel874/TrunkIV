...
$sql="update tblprojects set IsRead=:isread where id=:did";
...
date_default_timezone_set('Asia/Kolkata');
$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));
$sql="update tblprojects set AdminRemark=:description,Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
$query = $dbh->prepare($sql);
...
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
$msg="Project Action Taken Successfully";
}
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Project Details</div>
                    </div>
...
$sql = "SELECT tblprojects.id as lid,tblclients.FirstName,tblclients.LastName,tblclients.EmpId,tblclients.id,tblclients.Sector,tblclients.Phonenumber,tblclients.EmailId,tblprojects.ProjectType,tblprojects.ToDate,tblprojects.FromDate,tblprojects.Description,tblprojects.PostingDate,tblprojects.Status,tblprojects.AdminRemark,tblprojects.AdminRemarkDate from tblprojects join tblclients on tblprojects.empid=tblclients.id where tblprojects.id=:lid";
$query = $dbh -> prepare($sql);
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Client Name :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Sector :</b></td>
                                              <td><?php echo htmlentities($result->Sector);?></td>
                                          </tr>

                                          <tr>
                                             <td style="font-size:16px;"><b>Client Email id :</b></td>
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Client Contact No. :</b></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Project Type :</b></td>
                                            <td><?php echo htmlentities($result->ProjectType);?></td>
                                             <td style="font-size:16px;"><b>Project Date . :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Client Project Description : </b></td>
