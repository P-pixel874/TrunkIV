...
$sql="INSERT INTO tblprojecttype(ProjectType,Description) VALUES(:projecttype,:description)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Add Project Type</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Project Type</div>
                    </div>
...
<input id="projecttype" type="text"  class="validate" autocomplete="off" name="projecttype"  required>
