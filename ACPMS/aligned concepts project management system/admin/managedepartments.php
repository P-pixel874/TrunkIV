...
{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="editdepartment.php?deptid=<?php echo htmlentities($result->id);?>"><img src="icons/1522442-200.png" width="30" style="color: blue"><big></big></i></a><a href="managedepartments.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <img src="icons/1878128-200.png" width="30" style="color: blue"><big></big></i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
