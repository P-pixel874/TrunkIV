...
$sql="update tblclients set FirstName=:fname,LastName=:lname,Sector=:sector,DoApp=:doApp,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Update client</h4></div>
                    </div>
