...
$sql="INSERT INTO tblclients(EmpId,FirstName,LastName,EmailId,Password,Sector,DoApp,Department,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:sector,:doApp,:department,:address,:city,:country,:mobileno,:status)";
