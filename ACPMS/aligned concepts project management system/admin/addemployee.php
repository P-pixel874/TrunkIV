...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Sector,DoApp,Department,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:sector,:doApp,:department,:address,:city,:country,:mobileno,:status)";
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Add Client</h4></div>
                    </div>
...
<div class="row">
<div class="input-field col m6 s12">
<select  name="sector" autocomplete="off">
