...
$sql="INSERT INTO tblprojects(ProjectType,ToDate,FromDate,Description,Status,IsRead,empid) VALUES(:projecttype,:fromdate,:todate,:description,:status,:isread,:empid)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Client | Apply project</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Apply for Project</h4></div>
                    </div>
...
<select  name="projecttype" autocomplete="off">
...
<?php }} ?>
 ...
 <h6><i>Which dates do you expect the project to commence and wind up!</i></h6>
...
<label for="birthdate">Description of project</label>    
