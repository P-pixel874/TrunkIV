...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Project | Project History</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h5>Project History</h5></div>
                    </div>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT ProjectType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblprojects where empid=:eid";
