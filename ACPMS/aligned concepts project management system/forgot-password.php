        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">ELMS | Client Project Management System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><img src="icons/2110140-200.png" width="45" style="color: blue"><big>MY HOME</big></li>
                

                    <li class="no-padding"><a class="waves-effect waves-grey" href="client_home.php"> </i><img src="icons/1717484-200.png" width="45" style="color: blue"><big>LOGIN</big></a></li>
                   <br><br>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://nyamondoprox.simdif.com/">Developed by nyamondo </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Client Password Recovery</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Client details</span>
